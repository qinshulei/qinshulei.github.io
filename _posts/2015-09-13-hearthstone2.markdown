...
而贴吧常见的各种的钓鱼贴，引战贴都可以是轻松过百的回复。让人还是有些挫折感。:joy_cat:
...
开包几橙一直是热门话题，无数玩家，因开出的橙太少，要怒删游戏。:rage:

那到底开出几橙算少，几橙算多呢。:confused:
...
从数据中可以看出60包三传说 是概率最高的，但和两传说和四传说的概率差距很小。
因此 **开出 两张，三张，四张 ，五张 都算平均水平。 比两张少有点悲剧，超过五张比较 Lucky.** :kissing_heart:
